...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        captions_in_embd, embd_cache = word_embedding_forward(captions_in, W_embed)
        if self.cell_type == 'rnn':
            h, cache = rnn_forward(captions_in_embd, h0, Wx, Wh, b)
        elif self.cell_type == 'lstm':
            h, cache = lstm_forward(captions_in_embd, h0, Wx, Wh, b)
        ...
        if self.cell_type == 'rnn':
            drnn, dh0, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(dtemp, cache)
        elif self.cell_type == 'lstm':
            drnn, dh0, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(dtemp, cache)
        grads['W_embed'] = word_embedding_backward(drnn, embd_cache)
